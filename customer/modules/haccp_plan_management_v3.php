...
<head>
    ...
    <title>HACCP Risk Assessment - <?php echo htmlspecialchars($company['name']); ?></title>
            ...
            <div class="module-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="mb-0">Systematic hazard identification and risk evaluation for <?php echo htmlspecialchars($company['name']); ?></p>
                    </div>
                    <div class="text-end">
                        ...
                        <a href="../../demo?page=marketplace" class="btn btn-light btn-sm mt-2">
