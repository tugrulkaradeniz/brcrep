...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="mb-0 opacity-75"><?php echo htmlspecialchars($company_name); ?></p>
                </div>
    ...
    <script>
        ...
        function openTaskModal(taskId) {
            ...
            // Implementation for task completion modal
            showNotification('Task completion modal would open here', 'info');
        }
